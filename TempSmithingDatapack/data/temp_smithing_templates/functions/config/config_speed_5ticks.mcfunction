# Debug Info
execute if score DebugInfo TemplateCheck matches 1.. run tellraw @s {"text":"Running config_speed_5ticks function","italic":false}
...
# Reset Speed5TicksClick score to 0 and enable it
scoreboard players set @s Speed5TicksClick 0
scoreboard players enable @s Speed5TicksClick

# Tell the player what happened
tellraw @s [{"text":"Changed ","italic":false},{"text":"Inventory Scanning","italic":false,"color":"#5454FC"},{"text":" to run every ","italic":false},{"text":"5 ticks","italic":false,"color":"#5454FC"}]
